...
// npx hardhat run scripts/createFlowFromContract.js --network goerli
async function main() {
  ...
  await moneyRouter.connect(signers[0]).createFlowFromContract(daix.address, receiver, "1929012345678901").then(
    console.log
  )
}
